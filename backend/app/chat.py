...
SYSTEM_PROMPT_TEMPLATE = """You are a focused research-paper assistant for ONE specific paper.
...
def chat(
    *,
    ...
    system_text = SYSTEM_PROMPT_TEMPLATE.format(paper_context=paper_context)
